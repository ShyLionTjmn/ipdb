...
CREATE TABLE gr4rs(
  ...
  gr4rs_rmask   INTEGER UNSIGNED NOT NULL COMMENT 'bitmask:  1-view names, 2-view other info and IPs, 4-take nets',
  `ts`          DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  fk_user_id    BIGINT UNSIGNED,
...
CREATE TABLE gr6rs(
  ...
  gr6rs_rmask   INTEGER UNSIGNED NOT NULL COMMENT 'bitmask:  1-view names, 2-view other info and IPs, 4-take nets',
  `ts`          DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  fk_user_id    BIGINT UNSIGNED,
